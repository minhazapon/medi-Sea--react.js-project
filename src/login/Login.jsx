...
const Login = () => {
	...
	const {signLog} = useContext(FireContext)
	...
	<div className="my-6 space-y-4"> 
		<button aria-label="Login with Google" type="button" className=" btn flex items-center justify-center w-full  space-x-4 border rounded-md focus:ring-2 focus:ring-offset-1 ">
